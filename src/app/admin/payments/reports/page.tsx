      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-[#1E2230] rounded-xl border border-white/10 p-5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-sm text-white/50">{t('admin.reports.stat.totalRevenue')}</span>
          </div>
        ...
        <div className="bg-[#1E2230] rounded-xl border border-white/10 p-5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-sm text-white/50">{t('admin.reports.stat.platformCommission')}</span>
          </div>
          <p className="text-2xl font-bold text-white">
            {formatPrice(commissionBreakdown.platformCommission)}
          </p>
          <p className="text-xs text-white/40 mt-1">{t('admin.reports.stat.commissionNote')}</p>
        </div>
        <div className="bg-[#1E2230] rounded-xl border border-white/10 p-5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-sm text-white/50">{t('admin.reports.stat.providerPayouts')}</span>
          </div>
          <p className="text-2xl font-bold text-white">
            {formatPrice(commissionBreakdown.providerPayouts)}
          </p>
          <p className="text-xs text-white/40 mt-1">{t('admin.reports.stat.payoutsNote')}</p>
        </div>
        <div className="bg-[#1E2230] rounded-xl border border-white/10 p-5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <span className="text-sm text-white/50">{t('admin.reports.stat.netRevenue')}</span>
          </div>
          <p className="text-2xl font-bold text-white">
            {formatPrice(commissionBreakdown.netRevenue)}
          </p>
          <p className="text-xs text-white/40 mt-1">{t('admin.reports.stat.netRevenueNote')}</p>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-white/50">{t('admin.reports.revenueByCategory.subtitle')}</p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-[#1E2230] rounded-2xl border border-white/10 p-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white">{t('admin.reports.topProviders.title')}</h3>
                <p className="text-sm text-white/50">{t('admin.reports.topProviders.subtitle')}</p>
              </div>
            </div>
          </div>
            ...
            {topProviders.map((provider, index) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-white/50">{t('admin.reports.topProviders.bookings', { count: String(provider.bookings) })}</p>
                </div>
      ...
      <div className="bg-[#1E2230] rounded-2xl border border-white/10 p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-white">{t('admin.reports.revenueTrend.title')}</h3>
              <p className="text-sm text-white/50">{t('admin.reports.revenueTrend.subtitle')}</p>
            </div>
          </div>
        </div>
        <div className="h-64 flex items-center justify-center bg-black/20 rounded-xl">
          <div className="text-center">
            ...
            <p className="text-white/40">{t('admin.reports.revenueTrend.placeholder')}</p>
            <p className="text-white/30 text-sm">{t('admin.reports.revenueTrend.connectAnalytics')}</p>
          </div>
        </div>
      </div>
    </div>
